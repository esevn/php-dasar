...
<body class="bg-gray-100 font-sans antialiased">
  <a href="logout.php">
    <button class="px-6 py-3 bg-primary text-white rounded-md font-semibold shadow-lg hover:bg-danger transition duration-300 m-4
    " onclick="return confirm('Seriusan mau keluar??')">Logout</button></a>

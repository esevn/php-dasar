...
<body>
    <div class="container flex flex-col items-center justify-center mx-auto my-10 p-5">
        ...
        <form action="" method="POST" class="bg-white p-6 rounded-lg shadow-md w-full max-w-lg">
            ...
            <input type="number" name="number" id="age" required class="mt-1 p-2 w-full border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:border-transparent">
            <label for="image">Gambar</label>
            <input type="text" name="image" id="image" required class="mt-1 p-2 w-full border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:border-transparent">

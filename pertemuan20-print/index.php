...
<body class="bg-slate-300">
  ...
  <div class="container flex flex-col justify-between mx-auto mt-10">
    <div class="flex justify-between ">
      <div class="flex p-2">
        <button class="p-2 rounded-lg mt-6 mb-4 ml-4 text-white bg-blue-500 w-fit shadow-lg hover:bg-blue-950 transition-all ease-in-out duration-700">
        ...
        <button class=" p-2 rounded-lg mt-6 mb-4 ml-4 text-white bg-blue-500 w-fit shadow-lg hover:bg-blue-950 transition-all ease-in-out duration-700">
          <a href="./print/print-student.php" target="_blank">Print?</a>
        </button>
      </div>
